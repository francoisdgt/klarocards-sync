...
function kcsync_update_existing_post($board_story, $wp_post, $config, $parsedown) {
    ...
    if (!isset($board_story['updatedAt']) || 
        strtotime($wp_post->post_modified_gmt) >= strtotime($board_story['updatedAt'])) {
